...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/xiak/grafana-app-with-backend/pkg/common/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/xiak/grafana-app-with-backend/pkg/common/transport/http/binding")
)

var methodSets = make(map[string]int)

// generateFile generates a _http.pb.go file containing errors definitions.
