...
func TestEncodeValues(t *testing.T) {
	in := &complex.Complex{
		...
		MapInt64Key: map[int64]string{1: "xiak", 2: "go-zero"},
	...
	want := "a=19&age=18&b=true&bool=false&byte=MTIz&bytes=MTIz&count=3&d=22.22&double=12.33&duration=2m0.000000022s&field=1%2C2&float=12.34&id=2233&int32=32&int64=64&map%5Bxiak%5D=https%3A%2F%2Fgo-xiak.dev%2F&map%5Bxiak_start%5D=https%3A%2F%2Fgo-xiak.dev%2Fen%2Fdocs%2Fgetting-started%2Fstart%2F&map_int64_key%5B1%5D=xiak&map_int64_key%5B2%5D=go-zero&numberOne=2233&price=11.23&sex=woman&simples=3344&simples=5566&string=go-xiak&timestamp=1970-01-01T00%3A00%3A20.000000002Z&uint32=32&uint64=64&very_simple.component=5566" // nolint:lll
